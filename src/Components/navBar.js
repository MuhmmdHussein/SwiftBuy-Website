      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-between sm:items-stretch">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 space-x-4 sm:static sm:space-x-6">
              <Link
                to="/Registration"
        ...
        <div className={`sm:hidden ${isOpen ? 'block' : 'hidden'}`} id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            <button
              className="block px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white flex items-center"
              onClick={navigateToCart}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
